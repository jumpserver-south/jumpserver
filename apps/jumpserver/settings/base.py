...
# 证书登录
UKEY_API_ID = CONFIG.UKEY_API_ID
UKEY_API_VERSION = CONFIG.UKEY_API_VERSION
UKEY_APP_SUB_ID = CONFIG.UKEY_APP_SUB_ID
UKEY_APP_TOKEN = CONFIG.UKEY_APP_TOKEN
UKEY_ENV = CONFIG.UKEY_ENV
UKEY_PARTNER_ID = CONFIG.UKEY_PARTNER_ID
UKEY_SIGN = CONFIG.UKEY_SIGN
UKEY_SYS_ID = CONFIG.UKEY_SYS_ID
UKEY_USER_TOKEN = CONFIG.UKEY_USER_TOKEN
UKEY_APP_KEY = CONFIG.UKEY_APP_KEY
UKEY_ECSB_DOMAIN = CONFIG.UKEY_ECSB_DOMAIN
UKEY_CLIENT_ID = CONFIG.UKEY_CLIENT_ID
UKEY_APPKEY = CONFIG.UKEY_APPKEY
